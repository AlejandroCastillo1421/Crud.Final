 ...
 <div class="top-bar">
 		<div class="top-bar-left">
 			<ul class="menu">
 				...
 				<li><a href="#" id="lnkRefresh">Refresh</a></li>
 ...
 <div class="row column">
 	...
 	<div class="callout secondary" id="divFormDetails">
 		...
 		<form method="post" id="frmUpdate">
 			...
 			<div class="medium-12 columns">
 				<label>Ingrese el Contenido
 					<textarea name="content" placeholder="ej. Lorem ipsum..." id="txtContent"></textarea>
...
<script src="http://dhbhdrzi4tiry.cloudfront.net/cdn/sities/foundation.js"></script>
<script>
	$(document).foundation();
</script>
